import svgPaths from "./svg-twku1j635t";
    ...
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px relative w-full">
      ...
      <div className="bg-[#1a1b1f] relative rounded-[8px] shrink-0 w-full" data-name="Processing Card">
        <div className="flex flex-col justify-center size-full">
          <div className="content-stretch flex flex-col gap-[8px] items-start justify-center p-[8px] relative size-full">
            <Frame7 />
            <Frame14 />
          </div>
        </div>
...
export default function StartConversationPlanningState() {
  return (
    <div className="bg-[#121419] content-stretch flex flex-col items-center justify-between relative rounded-[24px] size-full" data-name="Start Conversation_Planning State">
