...
export function BrainBriefModal({ isOpen, onClose, onViewFullAnalysis, scale = 1 }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Popup: 870 × 368 px — scaled with frame */}
      <div
        className={`bb-popup${play ? " bb-play" : ""}`}
        style={{ width: 870, height: 368, background: "#040802", border: "1px solid rgba(255,255,255,.2)", borderRadius: 4, display: "flex", flexDirection: "column", gap: 8, overflow: "hidden", fontFamily: "Poppins, sans-serif", WebkitFontSmoothing: "antialiased", flexShrink: 0, transform: `scale(${scale})`, transformOrigin: "center" }}
      >
        {/* Header */}
        ...
        {/* Body */}
        <div style={{ display: "flex", gap: 16, alignItems: "flex-start", padding: "8px 20px 20px", flex: 1, minHeight: 0 }}>
          ...
          <div style={{ background: "rgba(227,231,234,.05)", borderRadius: 4, padding: 16, display: "flex", flexDirection: "column", gap: 16, alignItems: "center", flexShrink: 0, width: 400 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, width: "100%" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                ...
                <span style={{ fontWeight: 500, fontSize: 12, lineHeight: "18px", color: "rgba(255,255,255,.5)", whiteSpace: "nowrap" }}>2026/02/04 07:00</span>
              </div>
              <div style={{ fontWeight: 500, fontSize: 13, lineHeight: "18px", color: "rgba(255,255,255,.8)" }}>Your trading remained consistent this week, with disciplined execution and stable position sizing.</div>
            </div>
            ...
            <div style={{ border: "1px solid rgba(255,255,255,.1)", borderRadius: 4, padding: 12, display: "flex", gap: 24, alignItems: "center" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", width: 236 }}>
                <span style={{ fontWeight: 500, fontSize: 12, lineHeight: "18px", color: "rgba(255,255,255,.5)" }}>Behavioral Health Score</span>
                <span style={{ fontWeight: 600, fontSize: 12, lineHeight: "18px", color: "#1be9a8" }}>Improving ▲</span>
                  ...
                  <svg style={{ position: "absolute", top: 0, left: 0, width: 236, height: 80, overflow: "visible" }} viewBox="0 0 236 80" fill="none">
                    <defs>
                      <linearGradient id="bb-areaGrad" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="0%"   stopColor="#1be9a8" stopOpacity=".35"/>
                        <stop offset="100%" stopColor="#1be9a8" stopOpacity=".02"/>
                      </linearGradient>
                    ...
                    <g clipPath="url(#bb-sweep)">
                      <path d="M14 47 L54 43 L93 45 L131 40 L164 45 L199 38 L223 39 L223 80 L14 80 Z" fill="url(#bb-areaGrad)"/>
                      <path d="M14 47 L54 43 L93 45 L131 40 L164 45 L199 38 L223 39" fill="none" stroke="#1be9a8" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
                    </g>
                    <ellipse className="bb-glow" cx="223" cy="39" rx="9" ry="9" fill="#1be9a8"/>
                    <circle className="bb-dot" cx="14"  cy="47" r="3" fill="#000" stroke="#1be9a8" strokeWidth="1.2" style={{"--d": ".30s"} as React.CSSProperties}/>
                    <circle className="bb-dot" cx="54"  cy="43" r="3" fill="#000" stroke="#1be9a8" strokeWidth="1.2" style={{"--d": ".60s"} as React.CSSProperties}/>
                    <circle className="bb-dot" cx="93"  cy="45" r="3" fill="#000" stroke="#1be9a8" strokeWidth="1.2" style={{"--d": ".90s"} as React.CSSProperties}/>
                    <circle className="bb-dot" cx="131" cy="40" r="3" fill="#000" stroke="#1be9a8" strokeWidth="1.2" style={{"--d": "1.15s"} as React.CSSProperties}/>
                    <circle className="bb-dot" cx="164" cy="45" r="3" fill="#000" stroke="#1be9a8" strokeWidth="1.2" style={{"--d": "1.40s"} as React.CSSProperties}/>
                    <circle className="bb-dot" cx="199" cy="38" r="3" fill="#000" stroke="#1be9a8" strokeWidth="1.2" style={{"--d": "1.65s"} as React.CSSProperties}/>
                    <circle className="bb-dot" cx="223" cy="39" r="3" fill="#1be9a8" stroke="#1be9a8" strokeWidth="1.2" style={{"--d": "1.84s"} as React.CSSProperties}/>
                  </svg>
          ...
          {/* ── Right section ── */}
          <div style={{ display: "flex", flex: 1, minWidth: 0, flexDirection: "column", justifyContent: "space-between", height: "100%" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              {/* Stats row */}
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%" }}>
                <StatItem label="Emotional State"><span style={{ alignSelf: "flex-start", background: "#073b2a", color: "#1be9a8", fontWeight: 600, fontSize: 13, lineHeight: "18px", padding: "2px 8px", borderRadius: 8 }}>Steady</span></StatItem>
                <Divider />
                <StatItem label="Health Score"><div style={{ display: "flex", gap: 6, alignItems: "center" }}><span style={{ fontWeight: 600, fontSize: 14, lineHeight: "20px", color: "rgba(255,255,255,.8)" }}>85</span><span style={{ border: "1px solid #1be9a8", color: "#1be9a8", fontWeight: 600, fontSize: 13, lineHeight: "20px", padding: "1px 6px", borderRadius: 8, display: "flex", alignItems: "center" }}>Excellent</span></div></StatItem>
                <Divider />
                <StatItem label="Win Rate"><span style={{ fontWeight: 600, fontSize: 14, lineHeight: "20px", color: "rgba(255,255,255,.8)", whiteSpace: "nowrap" }}>67%</span></StatItem>
                <Divider />
                <StatItem label="Market Regime"><div style={{ display: "flex", gap: 6, alignItems: "center" }}><div style={{ width: 4, height: 4, background: "#1be9a8", flexShrink: 0 }}/><span style={{ fontWeight: 600, fontSize: 13, lineHeight: "20px", color: "rgba(255,255,255,.8)" }}>Aggressive</span></div></StatItem>
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 4, width: "100%" }}>
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                    <Notif num="01">Keep your position sizing consistent — it's one of your biggest strengths.</Notif>
                    <Notif num="02">Take one minute to review your best trade of the week.</Notif>
                  </div>
                </div>
                <span style={{ fontWeight: 500, fontSize: 12, lineHeight: "18px", color: "rgba(255,255,255,.5)" }}>Based on your trading behavior over the past 7 days</span>
              </div>
            </div>
...
function Notif({ num, children }: { num: string; children: string }) {
  return (
    <div style={{ background: "rgba(255,255,255,.05)", borderRadius: 4, padding: 12, width: "100%" }}>
      <div style={{ display: "flex", gap: 8, alignItems: "flex-start" }}>
        <div style={{ width: 22, display: "flex", justifyContent: "center", color: "#1be9a8", fontWeight: 500, fontSize: 14, lineHeight: "18px", flexShrink: 0 }}>{num}</div>
        <div style={{ flex: 1, fontWeight: 600, fontSize: 13, lineHeight: "18px", color: "rgba(255,255,255,.8)" }}>{children}</div>
      </div>
    </div>
  );
}
